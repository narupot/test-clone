...
class Product extends Model
{
    ...
    public static function getProductDetailAll($sku){
        return Self::where(['sku'=>$sku])->with(['productDesc','images','getShop','getShopDesc','categorydesc','tierPrices'])->first();
    }
    ...
    public static function getProductDetailByID2Edit($id){
        return Self::where(['id'=>$id])->with(['productDesc','images','getShop','getShopDesc','categorydesc','tierPrices', 'getbadge'])->first();
    }
    ...
    public function unit(){
        return $this->belongsTo('App\Unit','base_unit_id', 'id');
    }
