                ...
                if(count($order_shop)){
                    foreach ($order_shop as $key => $value) {                        
                        ...
                        $order_detail = \App\OrderDetail::query()
                            ->select('od.*', 'pw.avg_revised_weight') // หรือระบุ column ที่ต้องการเฉพาะ
                        ...
                        foreach ($order_detail as $dkey => $dvalue) {
                            ...
                            if(!empty($dvalue['avg_revised_weight'])){
                                $item_weight = $dvalue['avg_revised_weight'] * $dvalue['quantity'];
                            }else{
