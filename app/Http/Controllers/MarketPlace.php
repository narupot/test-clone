    ...
    */
    ...
    public function validateAddressForm($input) {
        ...
        if(isset($input['tax_invoice'])) {
            ...
            $rules['tax_id'] = 'Required|digits:13|numeric';;
        ...
        $error_msg['road.required'] = Lang::get('customer.road_is_required');  
    ...
    public function saveUserShippingBillingAddress($request, $data_arr) {
        ...
        $district_dtl = \App\CountryCityDistrict::getCityDetail($request->city_district);
        $city_district_name = $district_dtl->cityName->city_district_name;        

        $province_dtl = \App\CountryProvinceState::getProvinceDetail($request->province_state);
        $province_state_name = $province_dtl->provinceName->province_state_name;        
