                    ...
                    <li class="col-sm-4 <%list_class%>"  data-ng-repeat="item in product_Items | limitTo:pagination.itemsPerPage">
                        <div class="product-container">
                            ...
                            <div class="product-info">
                                @if(Auth::check())
                                    <span class="chat-wrap btn-buyer-chat d-none" data-val="<%item._id%>" ng-if="item.show_price.toString()=='1'">
                                        <a href="javascript:void(0);"><i class="fas fa-comments"></i></a>
                                    </span>                                   
                                @else 
                                    <span class="chat-wrap d-none" ng-if="item.show_price.toString()=='1'">
                               ...
                               <div class="shop-name">
                                    <a href="<%item.shop.shop_url%>" ng-bind="item.shop.shop_name"></a>
                               </div>
                               ...
                               {{--@if(Auth::check())
                                ...
                                @else
                                    ...
                                    <div class="action-btn" ng-if="((item.show_price.toString()=='1' && item.stock == 1) || (item.show_price.toString()=='1' && item.stock == 0 && item.quantity>=1))">
                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#loginModal" class="btn-default">@lang('product.talk_to_shop')</a>
