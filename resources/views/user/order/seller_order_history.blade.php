...
<a class="btn-grey" href="{{ action('User\OrderController@orderHistory') }}">@lang('order.by_main_order')</a> 
<a class="btn" href="{{ action('User\OrderController@sellerOrderHistory') }}">@lang('order.by_seller_order_buyer')</a>
        ...
        <table class="table order-history-buyer" id="order_history_buyer">
            <thead>
                <tr>
                    ...
                    <th>@lang('order.seller_order_no_buyer')</th>
...
<script>
    ...
    $(document).ready(function () {
        $('#order_history_buyer').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            ajax:{
                    "url": "{{ action('User\OrderController@sellerOrderHistoryData') }}",
                    "dataType": "json",
                    "type": "post",
