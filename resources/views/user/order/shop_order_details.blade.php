        ...
        <div class="table-content">
            @if(count($orderItems))
                ...
                <ul>
                    ...
                    <li><span class="mr"><img src="{{ getBadgeImageUrl($detail_json['badge']['icon'] ?? '' )}}" width="" class="h-atuo"></span></li>
        ...
        <div class="col-sm-10 float-right">         
            @if($orderShopData->total_credit_amount > 0)            
                <div class="row">
                    ...
                    <span class="col-6">{{ numberFormat($orderShopData->total_credit_amount) }} @lang('common.baht')</span>
                </div>
            @endif
            @if(($orderShopData->total_final_price - $orderShopData->total_credit_amount) > 0)            
                <div class="row">
                    ...
                    <span class="col-6">{{ numberFormat($orderShopData->total_final_price - $orderShopData->total_credit_amount) }} @lang('common.baht')</span>
                </div>
            @endif
