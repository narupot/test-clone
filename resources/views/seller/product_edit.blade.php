...
<div class="form-group">
            <label class="d-block mb-2" style="font-size: 1.1em; font-weight: bold;">@lang('product.select_product')<i class="red">*</i></label>
                ...
                @foreach($seller_prod_cat as $prod_cat)
                    <label class="category-item">
                        <input type="radio" name="product_cat" value="{{ $prod_cat->id }}" 
                                @if($prod_cat->id == $result->cat_id) checked @endif>
