         ...
         <div class="header-top">
            <div class="header-top-builder">
               ...
               <div class="header-col page-build-link dropdown">
                  <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><span class="text-nwrap">@lang('cms.page_builder')</span></a>
               ...
               <div class="header-col half-line page-name"><a href="javascript:void(0);"><span class="text-nwrap">@lang('cms.page_name')</span></a></div>
               <div class="header-col half-line page-history">
                  <a href="javascript:void(0);"><i class="fas fa-history"></i> <span class="text-nwrap">@lang('cms.history')</span></a>
               </div>
               <div class="header-col half-line new-page"><a href="javascript:void(0)"><span class="inner-bg p-1"><span class="text-nwrap"><i class="far fa-file"></i> @lang('cms.new_page')</span></span></a>
               </div>
               <div class="header-col no-border"><a href="javascript:void(0);" class="page-setting"><span class="inner-bg p-1"><i class="fas fa-cog"></i></span></a></div>
               ...
               <div class="header-col no-border">
                  <a href="javascript:void(0);" class="view-language-avail">Thai</a>
               </div>
