...
@endif --}}
    ...
    <a href="{{ $product->cat_url ?? '#' }}" class="text-decoration-none">
        ...
        <div class="product-item-info">
            ...
            <div class="product-info">
                ...
                <div class="price-wrap">
                   {{-- {{ route('product.detail', ['cat_url' => $product->category->url, 'sku' => $product->sku]) }} --}}
                    <div class="price-label mb-1">
                        {{ format_number($product->weight_per_unit) }}
                        {{ $product->unit_name }}
                    ...
                    <div class="normal-price text-white h5 px-3 py-1 bg-danger rounded mb-2 d-flex align-items-center justify-content-between">
                        <strong>฿{{ format_number($product->unit_price) }}</strong>
