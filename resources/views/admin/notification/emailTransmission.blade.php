    ...
    <div class="content">
        ...
        <form id="cmsForm" action="{{ action('Admin\Notification\MailTemplateController@updateEmailTransMethod') }}" method="post" class="form-horizontal form-bordered">
            ...
            <div class="content-wrap column-modal clearfix">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <ul class="nav nav-tabs chtabs">
                            ...
                            <li class="nav-item"><a class="nav-link show active" href="{{action('Admin\Notification\MailTemplateController@manageEmailTransmission')}}">@lang('admin_notification.email')</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{action('Admin\Notification\MailTemplateController@manageLineTransmission')}}">@lang('admin_notification.line_notification')</a></li>
                        </ul>
                                ...
                                <div class="form-row">
                                    <div class="col-sm-6">
                                         <div class="form-group striped-col">
                                            <label for="form-file-input">@lang('admin_notification.email_system') <i class="strick">*</i></label>
                                        ...
                                        <div class="form-group striped-col">
                                            <label for="form-file-input">@lang('admin_notification.email_provider') <i class="strick">*</i></label>
                                        ...
                                        <div class="form-group">
                                            <label for="form-text-input">@lang('admin_notification.host_name') <i class="strick">*</i></label>
                                        ...
                                        <div class="form-group">
                                            <label for="form-text-input">@lang('admin_notification.encription') <i class="strick">*</i></label>
                                        ...
                                        <div class="form-group">
                                            <label for="form-text-input">@lang('admin_notification.port_number') <i class="strick">*</i></label>
                                        ...
                                        <div class="form-group">
                                            <label for="form-text-input">@lang('admin_notification.username') <i class="strick">*</i></label>
                                        ...
                                        <div class="form-group">
                                            <label for="form-text-input">@lang('admin_notification.password') <i class="strick">*</i></label>
                ...
                {{--<div id="server_sms" class="desc" style="display: none;">
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="form-text-input">@lang('admin_notification.sms_url') <i class="strick">*</i></label>
                        <div class="col-md-8">
                            <input type="text" name="sms_url" id="sms_url" value="@if($default_sms_server->sms_url!='') {{$default_sms_server->sms_url}} @endif" class="form-control" placeholder="Enter Email">
                            <p class="error error-msg"></p>                                        
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="form-text-input">@lang('admin_notification.username') <i class="strick">*</i></label>
                        <div class="col-md-8">
                            <input type="text" name="username" id="username" value="@if($default_sms_server->username!='') {{$default_sms_server->username}} @endif" class="form-control" placeholder="Enter Username">
                            <p class="error error-msg"></p>                                        
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="form-text-input">@lang('admin_notification.password') <i class="strick">*</i></label>
                        <div class="col-md-8">
                            <input type="password" name="password" id="password" value="@if($default_sms_server->password!='') {{$default_sms_server->password}} @endif" class="form-control" placeholder="Enter Password">
                            <p class="error error-msg"></p>                                        
                        </div>
                    </div>
                </div>  --}}                                                      
