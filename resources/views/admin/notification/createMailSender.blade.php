...
@section('title')
    @lang('admin_notification.add_result')
@stop
...
@section('content')
    <div class="content">
        ...
        @endif 
        <form id="cmsForm" action="{{ action('Admin\Notification\MailTemplateController@senderStore')}}" method="post">
            <div class="header-title">
                <h1 class="title">@lang('admin_notification.add_result')</h1>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">                            
                            ...
                            <input type="text" name="sender_name" value="" class="form-control" placeholder="Sender Name">
                        ...
                        <div class="form-group">                            
                            ...
                            <input type="text" name="sender_email" value="" class="form-control" placeholder="Sender Email">
                        ...
                        <div class="form-group row">
                            <div class="col-md-5">
                                ...
                                <select class="select" name="status">
                                    <option value="1">@lang('admin_common.enable')</option>
                                    <option value="0">@lang('admin_common.disable')</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-5">
                                <label class="check-wrap mt-2">
                                    <input name="is_default" class="checkbox" type="checkbox">
                                    <span class="chk-label mt-2">
                                        {{ Lang::get('admin_common.default') }}
                                    </span>
                                </label>    
                            </div>
                        </div>
