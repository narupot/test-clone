...
@section('title')
    @lang('admin_notification.manage_sms_transmission_method')
@stop
...
@section('content')
    ...
    <div class="content">
        ...
        @endif 
        <form id="cmsForm" action="{{ action('Admin\Notification\MailTemplateController@updateSMSTransMethod') }}" method="post" class="form-horizontal form-bordered">
            <div class="header-title">
                <h1 class="title">@lang('admin_notification.manage_sms_transmission_method') </h1>
                <div class="float-right">
                    <button type="button" name="edit_server" class="btn btn-secondary d-none" id="edit_server">@lang('admin_common.edit')</button>
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <ul class="nav nav-tabs chtabs">
                            ...
                            <li class="nav-item"><a class="nav-link show active" href="{{action('Admin\Notification\MailTemplateController@manageSMSTransmission')}}">@lang('admin_notification.sms_notification')</a></li>
                                ...
                                <div class="form-row">
                                    <div class="col-sm-6">
                                        <div class="form-group striped-col">
                                            <label for="form-file-input">@lang('admin_notification.sms_provider') <i class="strick">*</i></label>
                                        ...
                                        <div class="dynamic_email_trans_container">
                                            <div class="form-group">
                                                ...
                                                <button type="button" name="test_sms_server" id="test_sms_server" value="test_sms_server" class="btn btn-secondary">@lang('admin_notification.test_sms_connection')</button>
                                            </div>
                                        </div>
                                        <div class="dynamic_email_trans_container">
                                            <div class="form-group">
...
<script type="text/javascript" >
    ...
    $(document).ready( function (){
        ...
        $("#test_sms_server").on('click', function(){
            ...
            $.ajax({
                url : "{{action('Admin\Notification\MailTemplateController@testSmsServerConnection')}}",
                method : "post",
                dataType : "json",
