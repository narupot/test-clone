<div class="modal-header">
    <h3 class="modal-title">@lang('admin_common.add_line_channel')</h3>
    <span class="fas fa-times close" data-dismiss="modal"></span> 
</div>
<form id="cmsForm" action="{{ action('Admin\Notification\MailTemplateController@storeLineChannel') }}" method="post">
{{ csrf_field() }}
{{ method_field('post') }}
                                ...
                                <div class="row">
									...
									<div class="dynamic_email_trans_container">
										<div class="form-group" style="margin-left:15px;">
											<button type="submit" name="submit" value="submit" class="btn btn-primary">@lang('admin_common.submit')</button>
										</div>
									</div>
                                </div>                         
                            </div> 
