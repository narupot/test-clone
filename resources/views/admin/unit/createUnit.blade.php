...
@section('title')
    @lang('admin_product.create_new_unit')
@stop
...
@section('content')
    <div class="content">
        ...
        @endif 
        <form id="unitForm"  method="post" action="{{ action('Admin\Unit\UnitController@store') }}" class="form-horizontal form-bordered" novalidate="novalidate" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="header-title">
                <h1 class="title">@lang('admin_product.create_new_unit')</h1>
                <div class="float-right">
                    <a class="btn btn-back" href="{{ action('Admin\Unit\UnitController@index') }}"><span><</span>@lang('admin_common.back')</a>
            ...
            <div class="content-wrap">
                ...
                <div class="form-group row">
                    <div class="col-md-5">                                          
                        {!! CustomHelpers::fieldstabWithLanuage([['field'=>'text', 'name'=>'unit_name', 'label'=>Lang::get('admin_product.unit_name').'<i class="strick">*</i>', 'errorkey'=>'un_name']], '1', $errors) !!}
...
<script type="text/javascript">
    ...
    (function($){
        ...
        var messages = {};
            messages['unit_name['+admin_default_lang+']'] = "@lang('admin_product.unit_name_is_required')";
