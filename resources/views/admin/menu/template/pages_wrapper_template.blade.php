    ...
    <div class="menu-edit-box">
        ...
        <div class="menu-edit-inner" data-nodrag  ng-show="collapsed">
                ...
                <div id="lang_<%lng.id%>_<%node.menu_type_id%>_<%node.temp_id%>" class="tab-pane fade" ng-repeat="lng in node.lang" ng-class="(menuData.default_lang_id == lng.id) ? 'show active':''">
                    <div class="form-group row">
                        <div class="col-sm-7">
                            ...
                            <input type="text" name="page-title-<%lng.code%>" ng-model="lng.input" value="" class="form-control" required>
                        </div>
                    </div>                    
                </div>
                <div class="category-container">    
                    <div class="form-group">
                        <label>@lang('admin_menu.page_id')<i class="red">*</i></label>
                        <div class="row">
                            <div class="col-sm-7">
                                <input type="text" name="page-selection-<%node.temp_id%>" class="form-control" ng-model="node.page_id" required>
                            </div>
                            <div class="col-sm-4">
                                <button class="btn btn-danger" data-toggle="modal" data-target="#pagesList" ng-click="selectNodeModal(node, 'page')">Select</button>
                            </div>                           
            ...
            <div class="menu-edit-icon-wrap">
                <h3>@lang('admin_menu.page_icon')</h3>                      
