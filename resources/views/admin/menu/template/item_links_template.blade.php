    ...
    <div class="menu-edit-box">
        <div class="list-item">
            ...
            <div class="float-right irem-wrap-icon" >
                <span class="pull-left">@lang('admin_menu.item_link')</span>
        ...
        <div class="menu-edit-inner" data-nodrag ng-show="collapsed">
            ...
            <div class="tab-content language-tab">
                <div id="lang_<%lng.id%>_<%node.menu_type_id%>_<%node.temp_id%>" class="tab-pane fade" ng-repeat="lng in node.lang" ng-class="{'show active' : $first}"> 
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <label><%lng.title%><i class="red" ng-show="menuData.default_lang_id == lng.id">*</i></label>
                                <input type="text" ng-model="lng.input" value="" name="link-title-<%lng.code%>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>@lang('admin_menu.item_url')<i class="red">*</i> </label>
                                <!-- <input type="text" ng-model="lang['atr_link_input']" name="link-url-<%node.temp_id%>" class="form-control" required> -->
                                <input type="text" ng-model="lng['atr_link_input']" name="link-url-<%lng.code%>" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <!--Page Link Start-->
                ...
                <div class="menu-edit-icon-wrap">
                    <h3>@lang('admin_menu.item_icon')</h3>
