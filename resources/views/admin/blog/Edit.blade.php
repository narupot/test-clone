            ...
            <div class="header-title">
                ...
                <div class="float-right btn-groups">
                    <a class="btn btn-back" href="{{ action('Admin\Blog\BlogController@index') }}">@lang('common.back')</a>
                        <button type="submit" name="submit_type" value="submit_continue" class="btn static-blog-save btn-secondary" data-action="submit_continue">@lang('common.save_and_continue')</button>
                    <button type="submit" name="submit_type" value="update" class="btn btn-save btn-success">@lang('common.save')</button>
                    
                    <a class="btn d-none btn-primary pr-4" id="revision" href="{{ action('Admin\Blog\BlogController@blogrevision',$blog_dtls->id) }}">@lang('common.revision')<span class="num revision-block">{{ $revision }}</span></a>
                ...
                <div class="content-left">
                    <div class="tablist">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link show active" data-toggle="tab" data-target="#general">@lang('blog.general')</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" data-target="#blogDetail">@lang('blog.blog_details')</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" data-target="#blogRelated">@lang('blog.blog_related')</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" data-target="#blogSlider">@lang('blog.blog_slider')</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" data-target="#blogSeo">@lang('blog.blog_seo')</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" data-target="#blogSocilashare">@lang('blog.blog_socialshare')</a></li>
                        </ul>
                    </div>
                </div>
                <div class="content-right container">                  
                    ...
                    <div class="tab-content">
                        <div id="blogDetail" class="tab-pane">
                            ...
                            <h2 class="title-prod">@lang('blog.blog_category')</h2>
                            <div class="form-group row">
                                <div class="col-sm-6">
                        ...
                        <div id="blogSlider" class="tab-pane">                            
                            ...
                            <div class="no-star">
                                <label class="mb-2">@lang('blog.blog_slider_image')</label>
                                <div class="addImgbutton">
                                    <div class="thumb-image-upload custom-height file-wrapper">
                                        ...
                                        <button type="button" id="sliderimagebtn" class="btn btn-primary mb-0">Add Images</button>
                        ...
                        <div id="general" class="tab-pane active">
                            <h2 class="title-prod">@lang('blog.general')</h2>

                            <div class="form-group row">
                                <div class="col-sm-6">
                                    
                                    <label>@lang('common.created_at')</label>
                                    <h6>{{ getDateFormat($blog_dtls->created_at,'1') }} </h6>
                                    @if($blog_dtls->created_by=='1')
                                    <h6>by @lang('common.admin')</h6>
                                    @endif
                                </div>
                                <div class="col-sm-6">
                                    <label>@lang('common.last_updated_at')</label>
                                    <h6>{{ getDateFormat($blog_dtls->updated_at,'1') }}</h6>
                                    @if($blog_dtls->updated_by=='1')
                                    <h6>by @lang('common.admin')</h6>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-4">
                                    <label>@lang('blog.publish_date') <i class="strick">*</i></label>  
                                    <input type="text" id="datepickers" class="date-select" name="publish_date" value="{{$blog_dtls->publish_date}}" >
                                    <p class="error" id="publish_date"></p>
                                    </div>
                                </div>                               
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div>
                                    {!! Form::text('start_date', old('start_date', date('d-m-Y',strtotime($blog_dtls->start_date))), ['class' => 'date-select date-picker flatpickr', 'id'=>'start_date'] ) !!}
                            ...
                            <div class="col-sm-4">
                                ...
                                <div>
                                    {!! Form::text('end_date', old('end_date', !empty($blog_dtls->end_date) &&($blog_dtls->end_date != '0000-00-00')? date('d-m-Y',strtotime($blog_dtls->end_date)):''), ['class' => 'form-control date-select date-picker flatpickr', 'id'=>'end_date'] ) !!}
                                </div>
                            </div>
                        </div>
