...
@section('content')
	<div class="content">
		...
		<div class="content-wrap">
			...
			<form id="addCountryForm" action="{{ action('Admin\SEO\SeoGlobalController@store') }}" method="post" enctype="multipart/form-data" class="row">
					{{ csrf_field() }}
					<div class="col-sm-6">		
						<div class="form-group">
							  <label>@lang('seo.template_user_for')</label>
								{!! Form::select('type', ['1'=>Lang::get('seo.products'), '2'=>Lang::get('seo.others')],  2,['class' => 'form-control']) !!}                                      
						...
						<div class="form-group">
							...
							<input type="text" name="title" value="{{ old('title') }}" class="form-control" placeholder="eg: Product, Category etc.">
							@if($errors->has('title'))
						 ...
						 <!--div class="form-group">
							 <label class="col-md-3 control-label" for="form-text-input">Slug*</label> 
									<div class="col-md-4">
											<input type="text" name="slug" value="{{ old('slug') }}" class="form-control" placeholder="eg: product, category etc.">
											@if($errors->has('slug'))
													<p class="error error-msg">{{ $errors->first('slug') }}</p>
											@endif                                    
									</div>
							</div-->
						...
						<div class="form-group">
							...
							<div class="formgroup-lang">{!! CustomHelpers::textWithLanuage('text', 'meta_title', '', 'meta-title', $errors, 'meta_title') !!}</div>
						...
						<!--div class="form-group">
								<label class="col-md-3 control-label" for="form-text-input">Meta Robots</label>
								<div class="col-md-1">
									{!! Form::checkbox('meta_robots', '1', false,   ['class' => '', 'id'=>'meta_robots'] ) !!}
							 </div>
							 <div class="col-md-5">noindex, follow</div>
