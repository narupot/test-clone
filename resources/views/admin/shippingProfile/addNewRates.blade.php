...
@section('content')
    <div class="content ng-cloak" ng-controller="shipProfileCtrl" ng-cloak>
        ...
        <form  action="{{action('Admin\ShippingProfile\ShippingRateTableController@saveRate')}}" method="post" class="" data-validate  data-invalid-class="invalid">
            {{ csrf_field() }}
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div id="province_state_type">
                                        {!! CustomHelpers::fieldstabWithLanuage([['field'=>'text', 'name'=>'province_state', 'label'=>'Title', 'errorkey'=>'province_state']], '1', $errors) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div id="district_city_type">
                                        {!! CustomHelpers::fieldstabWithLanuage([['field'=>'text', 'name'=>'district_city', 'label'=>'Title', 'errorkey'=>'district_city']], '2', $errors) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div id="sub_district_type">
                                        {!! CustomHelpers::fieldstabWithLanuage([['field'=>'text', 'name'=>'sub_district', 'label'=>'Title', 'errorkey'=>'sub_district']], '3', $errors) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="zip_from" value="*">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5">@lang('admin_shipping.zip_to')</label>
                                <div class="col-sm-7">
                                   <input type="text" name="zip_to" value="*">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12" >
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" name="weight_from" value="0" min="0" max="9999999">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5">@lang('admin_shipping.weight_to')</label>
                                <div class="col-sm-7">
                                    <input type="number" name="weight_to" value="0" min="0" max="9999999">
                                    <p>@lang('admin_shipping.no_limit')</p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5">@lang('admin_shipping.qty_from')</label>
                                <div class="col-sm-7">
                                    <input type="number" name="qty_from" value="0" min="0" max="9999999" size="7">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5">@lang('admin_shipping.qty_to')</label>
                                <div class="col-sm-7">
                                    <input type="number" name="qty_to" value="0" min="0" max="9999999">
                                    <p>@lang('admin_shipping.no_limit')</p>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                   <input type="number" name="price_from" value="0" min="0" max="9999999" size="7">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5">@lang('admin_shipping.price_to')</label>
                                <div class="col-sm-7">
                                    <input type="number" name="price_to" value="0" min="0" max="9999999">
                                    <p>@lang('admin_shipping.no_limit')</p>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="col-sm-12" >
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="base_rate_for_order" value="0.00" step="0.01">
                                    </div>
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="logistic_base_rate_for_order" value="0.00" step="0.01">
                                    </div>
                                </div>
                                <div class="form-group form-row">
                                    <label class="col-sm-6 check-wrap" >
                                    ...
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="percentage_rate_per_product" value="0.00" step="0.01">
                                    </div>
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="logistic_percentage_rate_per_product" value="0.00" step="0.01">
                                    </div>
                                </div>
                                <div class="form-group form-row">
                                    <label class="col-sm-6 check-wrap">
                                    ...
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="fixed_rate_per_product" value="0.00" step="0.01">
                                    </div>
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="logistic_fixed_rate_per_product" value="0.00" step="0.01">
                                    </div>
                                </div>
                                <div class="form-group form-row">
                                    <label class="col-sm-6 check-wrap">
                                    ...
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="fixed_rate_per_unit_weight" value="0.00" step="0.01">
                                    </div>
                                    <div class="col-sm-3 chbk-container">
                                        <input type="number" name="logistic_fixed_rate_per_unit_weight" value="0.00" step="0.01">
                                    </div>
                                </div>
                                <div class="form-group form-row">
                                    <label class="col-sm-6">@lang('admin_shipping.estimate_ship_time')</label>
                                    <div class="col-sm-6">
                                        <input type="number" name="estimate_shipping" value="1">
                                    </div>
                                </div>
                                <div class="form-group form-row">
                                    <label class="col-sm-6">@lang('admin_shipping.priority')</label>
                                    <div class="col-sm-6">
...
<script stype="text/javascript" src="{{Config('constants.js_url')}}angular/smmApp/controller/shipProfileCtrl.js"></script>
