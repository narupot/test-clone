<div class="" id="crop-avatar">
   <label>@lang('common.choose_banner') <i class="strick">*</i></label> 
   <div class="avatar-view single-file-upload" title="Change the Site Logo" style="    width: 148px;height: 210px;margin-left: 0px;">
      <img src="{{ Config::get('constants.loader_url')}}please_upload_image.jpg" alt="" id="avatar_image" name="images[SITE_LOGO_HEADER]">
   </div>
      ...
      <div class="modal-dialog modal-lg">
         <div class="modal-content">
            <div name="avatar_images" class="avatar-form" >
               ...
               <div class="modal-body mt-10">
                  <div class="avatar-body">
                     ...
                     <div class="avatar-upload">
                        ...
                        <div class="mb-2 clearfix"><label for="avatarInput">Local upload</label></div>
               ...
               <div class="clearfix nopadding custome-background text-right">
                  <div class="col-md-12 footer-btn">
                     <button type="button" class="btn-create avatar-save">Done</button>
                  </div>
               </div>
            </div>
         </div>
