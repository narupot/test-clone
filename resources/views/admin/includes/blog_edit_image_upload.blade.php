       ...
       <ul class="files">
         <li ng-repeat="file in blog.prevImage">
            ...
            <div class="col-sm-2">
             ...
             <div class="col-sm-6">
                 <p><label class="radio-wrap">                               
                  <input name="default_image" type="radio" value="<%$index%>" ng-model="blog.prevDefaultImage"  ng-change="addCheckAttrInItem(file,'prevImg',$index)"/> <span class="radio-label">@lang('blog.set_as_display_img')</span>
                  </label>
                 </p>
             </div>
             <div class="col-sm-2">
                 <button type="button" class="btn btn-delete" ng-hide="file.is_default==1"  ng-click="deletePrevUploadImg($event,file.id,$index)">
                    <span>@lang('blog.delete')</span>
                 </button>
             </div>
             </div>
         </li>
              ...
              <div class="row">
               ...
               <div class="col-sm-6">
                  ...
                  <p class="mt-10">
                   ...
                   <input name="default_image" type="radio" value="<%$index%>" ng-model="blog.defaultImage" ng-change="addCheckAttrInItem(item,'dropImg',$index)"/> <span class="radio-label">@lang('blog.set_as_display_img')</span>
                   </label>
                   </p>
               </div>
               <div class="col-sm-4">
  ...
  <div class="row fileupload-buttonbar">
      <div class="col-lg-12">
          ...
          <div class="float-right" ng-show="blogData.up_cl_all">
              ...
              <button type="button" class="btn" ng-click="onImageUpload(undefined, 'all_upload')">
                       Upload all
              </button>
          </div>
