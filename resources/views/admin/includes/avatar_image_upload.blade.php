<div class="" id="crop-avatar">
   ...
   <div class="avatar-view single-file-upload" title="Change the avatar">
      <img src="{{ Config::get('constants.loader_url')}}please_upload_image.jpg" alt="" id="avatar_image" name="avatar_image">
   </div>
            ...
            <div name="avatar_images" class="avatar-form" >
               ...
               <div class="clearfix nopadding custome-background text-right">
                  <div class="col-md-12 footer-btn">
                     <button type="button" class="btn-create avatar-save btn-secondary">Done</button>
                  </div>
               </div>
            </div>
         </div>
