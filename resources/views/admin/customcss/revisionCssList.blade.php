            ...
            <div class="tab-content listing-tab">
                <div class="tab-pane fade active show" id="staticPage">
                    <table class="table table-bordered " id="table">
                        ...
                        <tbody>
                        @foreach ($revisions as $key => $css_dtl)
                        
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $css_dtl['value'] }}</td>
                                <td>{{ $css_dtl['updated_at'] }}</td>
                                <td>
                                    <a class="link-primary" href="{{ action('Admin\CustomCss\CustomCssController@restorecssrevision',[$css_dtl->id]) }}">@lang('common.restore_this_revision')</a>
                                </td>
                            </tr>
                         @endforeach  
                         </tbody>
