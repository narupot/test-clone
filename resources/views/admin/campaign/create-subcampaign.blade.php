...
@section('title')
    ...
    Create {{$megaCampaign->name}} Campaign
@stop
...
@section('content')
    <div class="content">
        ...
        @endif 
        <form id="campaignForm"  method="post" action="{{ route('admin.campaign.subCampaign.store',['megaCampaignId'=>$megaCampaign->id]) }}" class=" form-horizontal form-bordered" novalidate="novalidate" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="header-title">
                <h1 class="title">Create {{$megaCampaign->name}} Campaign</h1>
                <div class="float-right">
                    <a class="btn btn-back" href="{{ action('Admin\Campaign\CampaignController@indexSubCampaign') }}"><span>< </span>@lang('admin_common.back')</a>
            ...
            <div class="content-wrap ">
                ...
                <div class="container mt-4 bg-white shadow-sm p-4 p-lg-5">
                    ...
                    <div class="form-group row pt-3">
                        <div class="col-md-5">
                            <label>Mega Campaign </label>
                            <select name="mega_campaign" class="valid" aria-invalid="false" disabled>
                                <option value="">{{$megaCampaign->name}}</option>
                            </select>
                        </div>
                    </div>
