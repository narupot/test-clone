<?php
    ...
    Route::group(array('prefix' => 'admin','middleware' => 'escape-back-history'), function () {
       ...
       /*Route::get('mail/create/{tempId}/{mail_type}', 'MailTemplateController@create');*/
        ...
        Route::group(array('prefix' => 'product'), function() {
            ...
            Route::post('deleteselected', 'Admin\Product\ProductController@deleteSelectedproducts');
    ...
    Route::group(['middleware' => 'is-seller'], function () { 
        Route::group(array('prefix' => 'seller'), function(){
            ...
            Route::group(array('prefix' => 'order'), function(){
                ...
                Route::get('delivery-list','Seller\OrderController@deliveryList');
    ...
    Route::group(['prefix' => 'checkout'], function () {
        ...
        Route::get('buy-now-end-shopping', 'Checkout\CartController@index')->name('buy-now-end-shopping');
        ...
        Route::get('kbank', 'Checkout\CartController@kbankPayment'); 
        ...
        /****payplus*******/
        Route::get('payplus', 'Checkout\CartController@payplusPayment'); 
        ...
        Route::post('payplus/submit','Checkout\CartController@createPayPlusOrder');
    });
    /**/
