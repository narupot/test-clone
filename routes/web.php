...
/* end Add code by games wms bcp */
    ...
    Route::post('smm-address-dd', 'AjaxController@getSmmAddressDD')->name('smm.address.dd');
    Route::post('smm-geocode-to-address', 'AjaxController@geocodeToSmm')->name('smm.geocode.to.address');
    Route::post('smm-check-delivery-zone', 'AjaxController@checkDeliveryZone')->name('smm.check.delivery.zone');
    ...
    Route::group(array('prefix' => 'admin','middleware' => 'escape-back-history'), function () {
        ...
        */
        ...
        Route::get('/ajax/get-geographies', 'Admin\ShippingProfile\ShippingRateTableController@getGeographies')->name('admin.ajax.get-geographies');
        Route::get('/ajax/get-provinces/{geographyId}', 'Admin\ShippingProfile\ShippingRateTableController@getProvinces');
        Route::get('/ajax/get-districts/{provinceId}', 'Admin\ShippingProfile\ShippingRateTableController@getDistricts');
        Route::get('/ajax/get-subdistricts/{districtId}', 'Admin\ShippingProfile\ShippingRateTableController@getSubDistricts');
        Route::post('/ajax/remove-subdistrict-usage', 'Admin\ShippingProfile\ShippingRateTableController@removeSubdistrictUsage')->name('admin.ajax.remove-subdistrict-usage');

        Route::post('/ajax/shipping/check-duplicate-zone', 'Admin\ShippingProfile\ShippingRateTableController@checkDuplicateZone')->name('admin.ajax.shipping.check-duplicate-zone');
        Route::get('/shipping/get-region-detail/{id}', 'Admin\ShippingProfile\ShippingRateTableController@getRegionDetail');
        Route::delete('/shipping/region/delete/{id}', 'Admin\ShippingProfile\ShippingRateTableController@deleteRegion');
        ...
        Route::get('list_seller/downloadpdf', 'Admin\Customer\SellerController@downloadPDF');
        ...
        Route::group(['prefix' => 'product-groups', 'as' => 'admin.product-groups.'], function () {
        ...
        Route::group(['prefix' => 'product-sub-groups', 'as' => 'admin.product-sub-groups.'], function () {
    ...
    Route::group(['prefix' => 'user','middleware' => 'escape-back-history'], function () {
        ...
        // ต้องประกาศก่อน resource เพื่อไม่ให้ route ทับ
        Route::get('address/map-picker', 'User\UserController@showMapPicker')->name('user.address.map-picker');
        Route::get('address/create', 'User\UserController@create')->name('user.address.create');
        Route::get('address', 'User\UserController@show')->name('user.address.index');
    ...
    Route::group(['prefix' => 'checkout'], function () {
        ...
        Route::post('checkout/get-pickup-slots', 'Checkout\CartController@getPickupOnlySlots');
