<?php
    ...
    Route::group(array('prefix' => 'admin','middleware' => 'escape-back-history'), function () {
        ...
        Route::post('discount-code/check-usable', 'Admin\DiscountCode\DiscountCodeController@checkUsable')->name('discount_code.check-usable');
        Route::post('discount-code/calulate-discount', 'Admin\DiscountCode\DiscountCodeController@calulateDiscount')->name('discount_code.calulate-discount');
