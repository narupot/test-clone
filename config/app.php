...
return [
    ...
    */
    ...
    'providers' => [
        ...
        /*
        Custome Service Providers added | By Dinesh Kumar kovid | 04/11/2017 | Start
        */
        App\Modules\ModulesServiceProvider::class,
        

        /*
        Custome Service Providers added | By Dinesh Kumar kovid | 04/11/2017 | End
        */

        /* Email server Configuration to manage from database | Start */
    ...
    */
    ...
    'aliases' => [
        ...
        'LayoutHtml' => App\Helpers\LayoutHtmlHelpers::class,
        'PopUpHelpers' => App\Helpers\PopUpHelpers::class,
        'Breadcrumb' => App\Helpers\Breadcrumb::class,
        'SEO' => App\Helpers\SeoHelpers::class,
