...
"use strict";
(function() {
    angular.module('sabinaAdminApp', ['jsonseivice','ui.grid','ui.grid.pagination','ui.grid.resizeColumns','ui.grid.selection','ui.grid.moveColumns','ui.grid.autoResize','ui.tree','ui.grid.draggable-rows','tableDepDir','ngTagsInput','ngDroplet','dndLists','ui.grid.saveState','angular-flatpickr'], function($httpProvider, $interpolateProvider) {
