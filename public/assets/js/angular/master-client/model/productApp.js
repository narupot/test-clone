...
(function() {
	//ae-datetimepicker
    angular.module('sabinaAdminApp', ['jsonseivice','ui.grid','ui.grid.pagination','ui.grid.resizeColumns','ui.grid.selection','ui.grid.moveColumns','ui.grid.autoResize','ui.tree','ui.grid.draggable-rows','tableDepDir','ngTagsInput','angular-flatpickr','ngDroplet','dndLists','froala'], function($httpProvider, $interpolateProvider) {
