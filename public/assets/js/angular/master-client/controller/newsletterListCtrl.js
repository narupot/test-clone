(function(){
  ...
  *****/
  function _megaMenuHandler($scope,salesfactoryData,$timeout){
    ...
    $scope.saveMenu = function(){
       salesfactoryData.getData('http://192.168.1.200:8000/en/admin/menu/save','POST',{data: $scope.data})
      .then(function(r){
        //response section
        //$scope.tree1 = r.data;
      },function(error){
    ...
    $scope.openItem = function(e,index){
        $('#item_'+e+'_'+index).toggle(200); 
        $scope.objId=e;
        $scope.objType='';
        $scope.objType=index;
    }; 
    ...
    //get Icon 
     ...
     //get Icon 
     $scope.removeIcon = function(iconName){
        $scope.linkMenuIcon ='link';
     };
     ...
     $scope.tree2 = [
                      {
                        ...
                        "title": "Item Wrapper",
                        "class": "",
                        "menuIcon": $scope.linkMenuIcon,
                        "menuParentIcon": 'item-wrap',
                        "atrtitle": "",
                        "atrlinkoptions" : "",
                        "atrLinkInput"   : "",
                        "atrcustomcss"   : "",
                       ...
                       },
                       {
                          ...
                          "title": "Item Link",
                          "class": "",
                          "menuIcon": 'folder-close',
                          "menuParentIcon": 'item-link',
                          "nodes": []
                        },
                        {
                          "id": 4,
                        ...
                        },
                        {
                          ...
                          "class": "",
                          "menuIcon": 'tasks',
                          "menuParentIcon": 'tree-link',
                          "nodes": []
                        }];
    //This function self executable for get data megamenu data
    _getMegaMenuData = function(){
      salesfactoryData.getData('http://192.168.1.200:8000/en/admin/menu/get','GET','')
      .then(function(r){
        //response section
        $scope.data = r.data;
      },function(error){
 ...
 //This function self executable for get data megamenu data
    _getMegaMenuList =function(){
      salesfactoryData.getData('http://192.168.1.200:8000/en/admin/menu/menulisting','GET','')
      .then(function(r){
        //response section
        $scope.data = r.data;
      },function(error){
  ...
  angular.module('sabinaAdminApp').controller('megamenuCtrl',_megaMenuHandler);
}).call(this);