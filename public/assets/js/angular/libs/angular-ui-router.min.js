...
/*****spinner loader rahi******/
(function(e){function r(e){function r(r,n){function a(r){e[r?"addClass":"removeClass"](n,"rahi-overlay-spinner-active")}r.$watch("active",a)}return{templateUrl:t,scope:{active:"="},transclude:!0,restrict:"EA",link:r}}function n(e){e.put(t,i)}var a=e.angular,t="/template/rahi-overlay-spinner/rahi-overlay-spinner.html",i="";i+='<div class="rahi-overlay-spinner-content">',i+='<div class="rahi-overlay-spinner-container">',i+='<div class="rahi-overlay-spinner"></div>',i+="</div>",i+="<ng-transclude></ng-transclude>",i+="</div>",a.module("rahi-overlay-spinner",["ngAnimate"]),a.module("rahi-overlay-spinner").directive("rahiOverlaySpinner",r),r.$inject=["$animate"],a.module("rahi-overlay-spinner").run(n),n.$inject=["$templateCache"]}).call(this,window);