...
$(function() {
    ...
    let dataModel = {
        ...
        url: typeof JQ_GRID_DATA_BLOG_URL != "undefined" ? JQ_GRID_DATA_BLOG_URL : "",
        beforeSend: (jqXHR, settings) => {
            //
        },
        getData: function(resp) {
            assigned_related_ids = blog_related;
            //console.log(assigned_related_ids);
            return {
    ...
    *****/
    ...
    if(typeof BATCH_SAVE_BLOG1!="undefined"){
    ...
    let $gridObj = $("div#jq_grid_table_blog").pqGrid({
        ...
        dataModel: dataModel,
        /** column config **/
        colModel: typeof columnBlogModel != "undefined" ? columnBlogModel : [],
        ...
        cellClick: function(evt, ui) {
            if(ui.column.type == 'checkbox'){
                if(ui.rowData.selected == false) {
                    assigned_related_ids.push(ui.rowData.id);
                } else {
                    assigned_related_ids.splice( assigned_related_ids.indexOf(ui.rowData.id), 1 );
                }
                $("#related_blog_ids").val(assigned_related_ids.join());
            }
        }
    });
