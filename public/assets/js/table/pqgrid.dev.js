...
! function(t) {
    ...
    e.render = {
        ...
        _summaryT: function(t, e, n, r, i, o, a) {
            for (var l, s, d, c, u, h = this, f = h.childstr, p = "groupModel" == h.model, g = o.summaryInTitleRow, v = h.that.colIndxs, m = o.showSummary, w = o.titleInFirstCol, x = 0, y = t.length, C = 0, b = {}, I = {}, _ = h.id, q = h.parentId, D = p && a ? o.dataIndx[a.pq_level] : "", R = [], M = n.length, T = pq.aggregate; M > C; C++) u = n[C], b[u] = [];
            for (; y > x; x++) {
            ...
            for (C = 0; M > C; C++) u = n[C], c = r[C], c = c[D] || c.type, I[u] = T[c](b[u], i[C], R), g && a && (0 == v[u] && w || (a[u] = I[u]));
            return !a || p && !m[a.pq_level] || (I.pq_level = a.pq_level, I[q] = a[_], e.push(I), a.pq_child_sum = I, I.pq_hidden = a.pq_close), I.pq_gsummary = !0, [I, b, R]
        },
        summaryT: function() {
...
function(t) {
    ...
    o._create = function() {
        ...
        e.iRenderB = new pq.cRenderBody(e, {
            $center: f,
            $b: g,
            $sum: e.$summary,
            header: !0,
            ...
            e.onfocus(t)
        }).on("mousedown", e._onMouseDown(e)).on("change", e._onChange(e)).on("mouseenter", ".pq-grid-cell,.pq-grid-number-cell", e._onCellMouseEnter(e)).on("mouseenter", ".pq-grid-row", e._onRowMouseEnter(e)).on("mouseleave", ".pq-grid-cell", e._onCellMouseLeave(e)).on("mouseleave", ".pq-grid-row", e._onRowMouseLeave(e)).on("keyup", e._onKeyUp(e)), n.selectionModel["native"] || this.disableSelection(), f.bind("keydown.pq-grid", e._onKeyPressDown(e)), this._refreshTitle(), e.iRows = new i.cRows(e), e.generateLoading(), e._initPager(), e._refreshResizable(), e._refreshDraggable(), e.iResizeColumns = new i.cResizeColumns(e)
    }, o.addTouch = function() {
        var e, n, r;
        ...
        if ("height" === t) a(), r._refreshResizable();
            ...
            } else "collapsible" === t ? (a(), r._createCollapse()) : "showBottom" === t ? (a(), r.$bottom.css("display", e ? "" : "none")) : "wrap" == t || "hwrap" == t ? ("wrap" == t ? l.$tbl.add(s.$tbl) : d.$tbl)[c(!e)]("pq-no-wrap") : "rowBorders" === t ? (a(), h = c(e), n = "pq-td-border-top", l.$tbl[h](n), s.$tbl[h](n)) : "columnBorders" === t ? (a(), h = c(e), n = "pq-td-border-right", l.$tbl[h](n), s.$tbl[h](n)) : a()
        }
        return r
    }, o.options = {
    ...
    a.refreshCM = function(t, e) {
        ...
        var e, n, r = t.column;
        return r || (e = this.normalize(t), r = e.column), n = r.editable, null != n ? "function" == typeof n ? (e = e || this.normalize(t), this.callFn(n, e)) : n : void 0
        ...
        if (void 0 === x && "function" == typeof c.geditor && (x = c.geditor.call(y, w)), x !== !1) {
            ...
            var T, k = I.type,
                E = null == r.select ? I.select : r.select,
                S = I.init,
                P = I.valueIndx,
                $ = I.dataMap,
                A = I.mapIndices,
            ...
            if (w.cls = F, w.attr = V, "function" == typeof k && (T = k.call(y, w), T && (k = T)), b._type = k, "checkbox" == k) {
                ...
                t(T).appendTo(M).val("select" == k && null != P && (A[P] || this.columns[P]) ? A[P] ? h[A[P]] : h[P] : m)
            } else k && "contenteditable" != k || (T = "<div contenteditable='true' tabindx='0' " + N + " " + V + " class='" + O + "'></div>", M.html(T), M.children().html(m), _ = !0);
            S && (w.$editor = M.children(".pq-editor-focus"), this.callFn(S, w));
        ...
        bodyKeyPressDown: function(e) {
            ...
            if (null != n && null != i && null != D.rowData) {
                ...
                if (l._trigger("cellKeyDown", e, M), I == y || I == C || I == x.UP || I == x.DOWN || g.onTab && I == b) {
                    ...
                    var E = I == x.PAGE_UP ? "pageUp" : "pageDown";
                    l.iRenderB[E](r, function(t) {
                        n = t + s, a.select({
                            rowIndx: n,
                            colIndx: i,
                            evt: e
                ...
                } else v.pressToEdit && (this.isEditKey(I) || u.on && 187 == I) && !w ? 46 == I ? l.clear() : (r = M.rowIndxPage, i = M.colIndx, S = l.getCell(M), S && S.length && l.isEditable(M) && l.editCell({
                    rowIndxPage: r,
                    colIndx: i,
                    select: !0
                }), T = !1) : T = !1;
            ...
            return function(r, i) {
                if (!e.dropPending) {
                    var o = 1 * i.draggable.attr("pq-col-indx"),
                        ...
                        c = e.leftDrop;
                    if (e.rtl && (c = !c), n._trigger("beforeColumnOrder", null, {
                            colIndxDrag: o,
                            colIndxDrop: s,
                            left: c
                        }) !== !1) {
...
function(t) {
    ...
    n.options.trackModel = {
        ...
        }), o != n.pdata && (n.pdata = o.slice(i, r.pageModel.rPP + i)), n._trigger("moveNode", null, {
            args: arguments
        }), n.refresh()
        ...
        onCellMouseDown: function(t, e) {
            if (!t.isDefaultPrevented()) {
                ...
                if ("cell" == l) {
                    ...
                    if (t.shiftKey && "single" !== s && d && null != d.firstR) {
                    ...
                    } else if (pq.isCtrl(t) && "single" !== s) this.mousedown = {
                        r1: r,
                        c1: o
                    }, i.add({
                        r1: r,
                        ...
                        e.colIndx = n.getFirstVisibleCI();
                        var h = n.getColModel().length;
                        i.resizeOrReplace({
                            r1: r,
                            c1: e.colIndx,
                            rc: 1,
                ...
                for (v = 0; S > v; v++) {
                    ...
                    for (E = k, z = 0; E > z; z++) {
                        ...
                        var G = z + w,
                            ...
                            Q = j[U],
                            X = K.dataIndx;
                        K.copy !== !1 ? (U++, N[X] = Q, L && (L[X] = u(V, K))) : (W++, "extend" == T && g > E + w && E++)
                    }
    ...
    r.beforeTrigger = function(t, e) {
        ...
        flattenG: function(t, e, n, r) {
            var i = this,
                ...
                d = i.childstr,
                c = n.separator,
                u = a ? i.firstCol().dataIndx : null,
                h = i.concat(),
                f = o.length,
                p = [];
            return function g(r, i, v, m) {
                if (!f) return r;
                v = v || {};
                var w = i || 0,
                    x = v[d],
                ...
                return b.forEach(function(t) {
                    ...
                    e = {
                        ...
                        pq_close: C,
                        pq_items: o
                    }, e[l] = i, e[s] = v[l], e[d] = [], e[y] = r, a && (e[u] = r), p.push(e), x && x.push(e), f > w + 1 ? g(n, w + 1, e, i) : p = h(p, n, e)
                }), p
            }
        },
        ...
        renderTitle: function(t, e) {
            ...
            return function(t) {
                ...
                return null != t.cellData ? (s = m.pq_close, h = m.pq_level, f = e.title, i.updateformatVal(e, t, h), f = w.renderLabel || f[h] || e.titleDefault, f = "function" == typeof f ? f.call(o, t) : f.replace("{0}", t.formatVal || t.cellData).replace("{1}", m.pq_items), f = null == f ? t.formatVal || t.cellData : f, v = s ? 1 : 0, g = "pq-group-icon " + p[v], t.Export ? f : (l && c && i.isCascade(e) && (n = i.renderCB(l, m, e.cbId), n && (r = n[0], n[1] && d.push(n[1]))), x = r && (null != x ? x : e.useLabel), {
                    text: [x ? "<label style='width:100%;'>" : "", "<span class='", g, "'></span>", r, f, x ? "</label>" : ""].join(""),
                    cls: d.join(" "),
...
function(t) {
    ...
    r.AnimH = function() {
        ...
        removeCols: function(e) {
            ...
            a.pq_render && (delete a.pq_render,
                n = e[1].each(function(n, r) {
    ...
    n.prototype = t.extend({}, pq.mixin.ChkGrpTree, pq.mixin.GrpTree, {
        ...
        moveNodes: function(t, e, n) {
            ...
            if (t.forEach(function(t) {
                ...
                for (d._trigger("beforeMoveNode"); a > w; w++) l = o[w], r = s.getParent(l), i = r[h].indexOf(l), r == e ? n = pq.moveItem(l, e[h], i, n) : (e[h].splice(n++, 0, l), r[h].splice(i, 1)), l[c] = v;
                f.data = s.flatten(s.getRoots()), d.refreshView(), d._trigger("moveNode", null, {
                    args: arguments
                })
            }
        },
...
function(t) {
    pq.excelImport = {
        ...
        getWorkSheet: function(t, e, n, r) {
            for (var i, o, a, l, s, d, c, u, h, f, p, g, v, m, w, x, y, C = this, b = [], I = 0, _ = pq.toNumber, q = this.getFormula(C), D = pq.isEmpty, R = pq.formulas, M = pq.isDateFormat, T = C.getMergeCells(t), k = e.match(/<row.*?<\/row>/g) || [], E = 0, S = k.length; S > E; E++) {
                d = {
                    cells: []
    ...
    var e = pq.excel = {
        ...
        exportWb: function(t) {
            var e = t.workbook,
                ...
                l = a.length,
                s = new JSZip;
            s.file("[Content_Types].xml", this.getContentTypes(l)), a.forEach(function(t, e) {
                var r = i.getCols(t.columns),
                    a = i.getFrozen(t.frozenRows, t.frozenCols, t.rtl),
                    l = i.getBody(t.rows),
                    d = i.getMergeCells(t.mergeCells);
                o.push(t.name), n && (l = l.replace.apply(l, n)), s.file("worksheet" + (e + 1) + ".xml", i.getSheet(a, r, l, d))
            }), s.file("workbook.xml", this.getWBook(o)), s.file("styles.xml", i.getStyle());
            var d = s.folder("_rels");
            return d.file(".rels", r.rels), d.file("workbook.xml.rels", this.getWBookRels(l)), t.url ? (t.data = s.generate({
                type: "base64",
                compression: "DEFLATE"
            }), t.decodeBase = !0, pq.postRequest(t)) : s.generate({
                type: t.type || "blob",
                compression: "DEFLATE"
            })
        },
    ...
    t.extend(n, {
        ...
        onAutofill: function(t) {
            var e = t.sel,
                ...
                d = i.colModel,
                c = d.length - 1,
                u = i.get_p_data().length - 1,
                h = d[a].dataIndx,
                f = r.getFnW(s, h);
            f && (t.series = function(t) {
                return "=" + (l ? n.shiftC(f.fn, t - 1, c) : n.shiftR(f.fn, t - 1, u))
            })
        },
        ...
        r = {
            ...
            groupData: function() {
                var t, e, r, i = this,
                    ...
                    u = !c && l.pivot,
                    h = d.length;
                if (u ? (h && (t = s.slice(), l.dataIndx = s = s.concat(d)), i.skipConcat = !0, e = l.titleInFirstCol, r = l.merge, l.titleInFirstCol = !1, l.fixCols = !0, l.merge = !1) : c && h && (t = s.slice(), l.dataIndx.length = l.dataIndx.length - 1, i.setPivot(!1)), n.groupData.call(i), u && (o.pdata = o.pdata.reduce(function(t, e) {
                        return e.pq_gtitle && t.push(e), t
                    }, [])), c && h && (l.dataIndx = t, i.setPivot(!0)), u) {
                    if (h) {
                        e ? (l.titleInFirstCol = !0, l.fixCols = !1) : t.length > 1 && (l.merge = r), i.pivotData(s, t), l.dataIndx = t.slice(0, t.length - 1), l.summaryInTitleRow = "all", i.skipConcat = !1;
    ...
    n.prototype = t.extend({}, pq.cRenderHS, new e.cHeader, new e.cHeaderSearch, {
        ...
        renderCell: function(t) {
            var e, n = t.rowData,
                ...
                l = t.style,
                s = n[i];
            return s ? (s.colSpan > 1 && l.push("z-index:3;"), this.createHeaderCell(r, i, s, o, a, l)) : (e = this.renderFilterCell(t.column, i, a), "<div " + o + " class='" + a.join(" ") + "' style='" + l.join("") + "'>" + e + "</div>")
        }
    })
}(jQuery),
function(t) {
