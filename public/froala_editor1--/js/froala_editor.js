...
(function (factory) {
  ...
  $.FE.MODULES.cursor = function (editor) {
    ...
    function _getExtremityCharacterLength(text, first) {
      ...
      var special_chars_regex = new RegExp(((first ? '^' : '')) + '([\\uD83C-\\uDBFF\\uDC00-\\uDFFF\\u200D]+)' + ((first ? '' : '$')), 'i');
    ...
    function _backspace (e) {
      ...
      if (editor.selection.isCollapsed()) {
        ...
        if (editor.helpers.isIOS()) {
          ...
          sel.modify('move', editor.opts.direction === 'rtl' ? 'left' : 'right', 'character');
        }
        else {
          e.preventDefault();
          e.stopPropagation();
    ...
    function _isEmpty (node) {
      ...
      try {
        return ((node.textContent || '').length === 0 && node.querySelector && !node.querySelector(':scope > br')) ||
              (node.childNodes && node.childNodes.length == 1 && node.childNodes[0].getAttribute && node.childNodes[0].getAttribute('contenteditable') == 'false');
      }
      catch (ex) {
        return false;
      }
      ...
      for (var i = 0; i < contents.length; i++) {
        ...
        // We should remove.
          ...
          // Remove everything starting with the most inner nodes which match the current selector.
            ...
            // Check inner nodes.
            if ((typeof tag == 'undefined' && node.nodeType == Node.ELEMENT_NODE && !editor.node.isVoid(node) && !editor.node.isBlock(node) && node.tagName !== 'A') || _matches(node, _query(tag, attrs))) {
...
$.FE.MODULES.data=function(a){function b(a){return a}function c(a){if(!a)return a;for(var c="",f=b("charCodeAt"),g=b("fromCharCode"),h=m.indexOf(a[0]),i=1;i<a.length-2;i++){for(var j=d(++h),k=a[f](i),l="";/[0-9-]/.test(a[i+1]);)l+=a[++i];l=parseInt(l,10)||0,k=e(k,j,l),k^=h-1&31,c+=String[g](k)}return c}function d(a){for(var b=a.toString(),c=0,d=0;d<b.length;d++)c+=parseInt(b.charAt(d),10);return c>10?c%9+1:c}function e(a,b,c){for(var d=Math.abs(c);d-- >0;)a-=b;return c<0&&(a+=123),a}function f(a){return!(!a||"block"===a.css("display"))&&(a.remove(),!0)}function g(b){return b&&0===a.$box.find(b).length}function h(){return f(k)||f(l)||g(k)||g(l)}function i(){return p>10&&(a[b(o("0ppecjvc=="))](),setTimeout(function(){$.FE=null},10)),!!a.$box&&(a.$wp.prepend(o(b(o("NCKB1zwtPA9tqzajXC2c2A7B-16VD3spzJ1C9C3D5oOF2OB1NB1LD7VA5QF4TE3gytXB2A4C-8VA2AC4E1D3GB2EB2KC3KD1MF1juuSB1A8C6yfbmd1B2a1A5qdsdB2tivbC3CB1KC1CH1eLA2sTF1B4I4H-7B-21UB6b1F5bzzzyAB4JC3MG2hjdKC1JE6C1E1cj1pD-16pUE5B4prra2B5ZB3D3C3pxj1EA6A3rnJA2C-7I-7JD9D1E1wYH1F3sTB5TA2G4H4ZA22qZA5BB3mjcvcCC3JB1xillavC-21VE6PC5SI4YC5C8mb1A3WC3BD2B5aoDA2qqAE3A5D-17fOD1D5RD4WC10tE6OAZC3nF-7b1C4A4D3qCF2fgmapcromlHA2QA6a1E1D3e1A6C2bie2F4iddnIA7B2mvnwcIB5OA1DB2OLQA3PB10WC7WC5d1E3uI-7b1D5D6b1E4D2arlAA4EA1F-11srxI-7MB1D7PF1E5B4adB-21YD5vrZH3D3xAC4E1A2GF2CF2J-7yNC2JE1MI2hH-7QB1C6B5B-9bA-7XB13a1B5VievwpKB4LA3NF-10H-9I-8hhaC-16nqPG4wsleTD5zqYF3h1G2B7B4yvGE2Pi1H-7C-21OE6B1uLD1kI4WC1E7C5g1D-8fue1C8C6c1D4D3Hpi1CC4kvGC2E1legallyXB4axVA11rsA4A-9nkdtlmzBA2GD3A13A6CB1dabE1lezrUE6RD5TB4A-7f1C8c1B5d1D4D3tyfCD5C2D2==")))),k=a.$wp.find("> div:first"),l=k.find("> a"),"rtl"==a.opts.direction&&k.css("left","auto").css("right",0).attr("direction","rtl"),void p++)}function j(){var c=a.o_win.FEK;try{c=c||localStorage&&localStorage.FEK}catch(d){}c=a.opts.key||c||[""];var e=o(b("ziRA1E3B9pA5B-11D-11xg1A3ZB5D1D4B-11ED2EG2pdeoC1clIH4wB-22yQD5uF4YE3E3A9=="));"string"==typeof c&&(c=[c]),a.ul=!0;for(var f=0;f<c.length;f++){var g=o(c[f])||"";if(!(g!==o(b(o("mcVRDoB1BGILD7YFe1BTXBA7B6==")))&&g.indexOf(n,g.length-n.length)<0&&[o("9qqG-7amjlwq=="),o("KA3B3C2A6D1D5H5H1A3=="),o("QzbzvxyB2yA-9m=="),o("ji1kacwmgG5bc=="),o("naamngiA3dA-16xtE-11C-9B1H-8sc==")].indexOf(n)<0)){a.ul=!1;break}}var j=new Image;a.ul===!0&&(i(),j.src=b(o(e))+"u"),a.ul===!0&&a.events.on("contentChanged",function(){h()&&i()}),a.events.on("destroy",function(){k&&k.length&&k.remove()},!0)}var k,l,m="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",n=function(){for(var a=0,b=document.domain,c=b.split("."),d="_gd"+(new Date).getTime();a<c.length-1&&document.cookie.indexOf(d+"="+d)==-1;)b=c.slice(-1-++a).join("."),document.cookie=d+"="+d+";domain="+b+";";return document.cookie=d+"=;expires=Thu, 01 Jan 1970 00:00:01 GMT;domain="+b+";",(b||"").replace(/(^\.*)|(\.*$)/g,"")}(),o=b(c),p=0;return{_init:j}}
    ...
    function clean (clipboard_html, is_word, keep_formatting) {
      ...
      if (!is_word) {
        ...
        if (!is_editor_content) {
          ...
          if (editor.opts.tabSpaces) {
            var txt = '';
            var u = 0;

            while (u++ < editor.opts.tabSpaces) {
              txt += '&nbsp;';
            }

            clipboard_html = clipboard_html.replace(/\t/g, txt);
          }
          else {
  ...
  $.extend($.FE.DEFAULTS, {
    iconsTemplate: $.FE.ICON_DEFAULT_TEMPLATE || 'font_awesome'
  });
  ...
  $.FE.MODULES.icon = function (editor) {
    function create (command) {
      ...
      if (typeof info != 'undefined') {
        var template = info.template || editor.opts.iconsTemplate;
    ...
    function getTemplate (command) {
      ...
      if (typeof info != 'undefined') {
        template = info.template || editor.opts.iconsTemplate;
