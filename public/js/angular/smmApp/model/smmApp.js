...
var tableConfig = {
	...
	chk_action : false,
	bulk_action : false,
	save_table_structure : false,	
};
if(fieldSetJson.tableConfig!==undefined) angular.extend(tableConfig, fieldSetJson.tableConfig[0]);

"use strict";
(function() {
    angular.module('smm-app', ['jsonseivice','ui.grid','ui.grid.pagination','ui.grid.resizeColumns','ui.grid.selection','ui.grid.moveColumns','ui.grid.autoResize','ui.tree','ui.grid.draggable-rows','tableDepDir','ngTagsInput','ngDroplet','dndLists','ui.grid.saveState','angular-flatpickr'], function($httpProvider, $interpolateProvider) {
		 ...
		 $provide.decorator('GridOptions',function($delegate){
		   var gridOptions;
		      ...
		      gridOptions.initialize = function(options) { 
				...
				initOptions.enableGridMenu = false;/*(tableConfig.col_setting !==undefined)? tableConfig.col_setting : false;*/
				initOptions.useExternalSorting = true;
				initOptions.rowHeight= 81;
				...
				initOptions.enableColumnMoving = false;/*(tableConfig.column_rearrange !==undefined)? tableConfig.column_rearrange : false;*/
				initOptions.enableColumnResize= false;/*(tableConfig.resizable !==undefined)? tableConfig.resizable : false;*/
